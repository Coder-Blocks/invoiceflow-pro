...
export default async function BillingPage() {
    ...
    return (
        <div className="space-y-8">
            ...
            <PlansList plans={plans} currentPlan={currentSubscription.plan} orgCurrency={currentSubscription.organization.currency} />

            {currentSubscription.paymentGateway !== 'MANUAL' && (
                <Card>
                    <CardHeader>
