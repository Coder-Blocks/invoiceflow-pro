...
export async function POST(req: Request) {
    ...
    try {
        ...
        const existingInvitation = await prisma.invitation.findFirst({ where: { organizationId: session.user.activeOrgId, email: validated.email, acceptedAt: null } });
